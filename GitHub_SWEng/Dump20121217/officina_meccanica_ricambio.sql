...
CREATE TABLE `ricambio` (
  `idricambio` int(11) NOT NULL AUTO_INCREMENT,
  `garanzia` tinyint(1) NOT NULL,
  `prezzo` float NOT NULL,
  `nome_ricambio` varchar(45) NOT NULL,
...
INSERT INTO `ricambio` VALUES (1,0,12.5,'filtri aria Arexon'),(2,0,14,'olio motore 6w-50'),(3,0,15.7,'olio cambio shell'),(4,1,67,'sedile Fiat Panda 93'),(5,1,115,'volante Golf '),(6,1,300,'cerchi in lega Fiat Bravo');
