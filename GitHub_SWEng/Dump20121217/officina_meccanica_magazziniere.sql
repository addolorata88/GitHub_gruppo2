...
CREATE TABLE `magazziniere` (
  `idmagazziniere` int(11) NOT NULL AUTO_INCREMENT,
  `nome` varchar(45) NOT NULL,
  `cognome` varchar(45) NOT NULL,
  `telefono` varchar(45) NOT NULL,
  `email` varchar(20) NOT NULL,
  `data_assunzione` varchar(45) NOT NULL,
  `scadenza contratto` varchar(45) NOT NULL,
...
INSERT INTO `magazziniere` VALUES (1,'Sandro','Ciolli','161432144','s.c@hotmail.it','2010-02-01','2020-02-01');
